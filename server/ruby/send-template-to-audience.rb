...
if audience_id.nil? || audience_id.empty?
  puts "Error: COURIER_SEND_TEMPLATE_TO_AUDIENCE_AUDIENCE_ID environment variable is required"
  exit 1
end

if template_id.nil? || template_id.empty?
  puts "Error: COURIER_SEND_TEMPLATE_TO_USER_ID_TEMPLATE_ID environment variable is required"
  exit 1
end
