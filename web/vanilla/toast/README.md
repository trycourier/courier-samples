...
- Select "Vanilla: Toast" from the dropdown
...
For complete reference documentation, see the [Courier Toast Web Components documentation](https://www.courier.com/docs/sdk-libraries/courier-ui-toast-web).
